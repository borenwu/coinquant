...
from Signals import signal_bolling
...
# 导入数据
# df = pd.read_hdf('/Users/jxing/Desktop/coin_quant_class/data/class8/eth_1min_data_180815.h5', key='min_data')
#
# # 转换数据周期
# rule_type = '15T'
...
#
# df = df[df['candle_begin_time'] > pd.to_datetime('2018-03-22')]
#
# df.to_csv('/Users/jxing/Desktop/a.csv', index=False)
# print('策略最终收益：', df.iloc[-1]['equity_curve'])
# exit()

# =====寻找最优参数
# 导入数据
all_data = pd.read_hdf('okb_data.h5', key='all_data')
# 转换数据周期
rule_type = '15T'
